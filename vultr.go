...
func (d *Driver) GetCreateFlags() []mcnflag.Flag {
	return []mcnflag.Flag{
		...
		mcnflag.IntFlag{
			EnvVar: "VULTR_VPSPLANID",
			Name:   "vultr-vpsplanid",
			Usage:  "VPS Plan ID",
...
func (d *Driver) SetConfigFromFlags(flags drivers.DriverOptions) error {
	...
	d.OSID = flags.Int("vultr-osid")
	d.DCID = flags.Int("vultr-dcid")
	d.VpsPlanId = flags.Int("vultr-vpsplanid")
	d.IpxeChainURL = flags.String("vultr-ipxe-chain-url")
	d.ISOID = flags.Int("vultr-isoid")
	d.ScriptId = flags.String("vultr-scriptid")
	d.SnapshotId = flags.String("vultr-snapshot")
	d.AppId = flags.String("vultr-appid")
